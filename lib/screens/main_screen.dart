...
//   }
//
//   Widget _buildRideOption(bool darkTheme, String title, String subtitle, IconData icon, String price) {
//     return GestureDetector(
//       onTap: () {
//         ScaffoldMessenger.of(context).showSnackBar(
//           SnackBar(content: Text("$title ride selected")),
//         );
//       },
//       child: Container(
...
//             ),
//
//             // Bottom UI - Only show when suggested rides is not visible
//             if (suggestedRidesContainerHeight == 0)
//               Positioned(
//                 bottom: 0,
//                 left: 0,
//                 right: 0,
